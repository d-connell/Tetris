...
public class LTetronimoTetronimo extends FourRotationsTetronimo {

    private static final Colour colour = Colour.ORANGE;
    private static final int firstBlockXPosition = 5;
    ...
    private static final int thirdBlockXPosition = 3;
    private static final int thirdBlockYPosition = 0;
    private static final int fourthBlockXPosition = 3;
    private static final int fourthBlockYPosition = 1;

    public LTetronimoTetronimo(Grid grid, GameRenderer gameRenderer) {
